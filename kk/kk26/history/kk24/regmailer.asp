...
If you chose to pay by credit, begin the process below.  You must receive a confirmation in order to ensure that your payment was accepted.  Upon receipt of such confirmation, consider your registration complete.  If you are having trouble completing payment by credit card, please contact us at kaimanatd@gmail.com.  Your credit card payment must be accepted before January 15, 2011 in order to pay the early registration fee.  Otherwise, you must pay $165</p>
<center>
<FORM action="https://www.linkpointcentral.com/lpc/servlet/lppay" method="post">
<INPUT type="hidden" name="mode" value="fullpay">
<html>
<head>
<title>Sample LinkPoint Connect Order Form</title>
</head>
<body>
<h1>Order Form</h1>
<FORM action="https://www.linkpointcentral.com/lpc/servlet/lppay" method="post">
<input type="hidden" name="storename" value="1055160">

  Payment Amount:
        <select name="chargetotal">
         <option value="blank">
	 <option value="420">Team Bid Fee: $420	 
       <option value="165">Regular Individual Player Fee: $165
	 <option value="80">Guest Fee: $80
       <option value="140">Aloha Spirit Fee: $140
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFff">
	<tr> 
	  ...
	  <td valign="top" width="700">
	    ...
	    Contact <a href="mailto:kaimanatd@gmail.com"><font color="#339966">kaimanatd at gmail dot com</font></a></em></p>
	  </td>
	  <td valign="top"><img alt="" src="images/space.gif" width="50" height="1" border="0"></td>
	</tr>
</table>
